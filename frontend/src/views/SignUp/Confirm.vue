        ...
        <div class="card-body">
          ...
          <b-form @submit="confirm">
            ...
            <b-form-group label="Email address" label-for="confirmEmail">
              <b-form-input id="confirmEmail" type="email" v-model="form.email" aria-describedby="confirmEmailError"
            ...
            <b-form-group label="Token" label-for="confirmToken">
              <b-form-input id="confirmToken" type="number" v-model="form.token" aria-describedby="confirmTokenError"
                :state="errors.token ? false : null" required>
              </b-form-input>
