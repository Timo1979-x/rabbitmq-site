        ...
        <div class="card-body">
          ...
          <b-form @submit="signup">
            ...
            <b-form-group label="Email address" label-for="signupEmail">
              <b-form-input id="signupEmail" type="email" v-model="form.email" aria-describedby="signupEmailError"
                :state="errors.email ? false : null" required>
              </b-form-input>
            ...
            <b-form-group label="Password" label-for="signupPassword">
              <b-form-input id="signupPassword" type="password" v-model="form.password"
                aria-describedby="signupPasswordError" :state="errors.password ? false : null" required>
              </b-form-input>
